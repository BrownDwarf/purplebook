...
Rstar = 1000.0 * k * N_avogadro  # Universal gas constant
#
...
# ------------------------
H2O = gas()
H2O.CriticalPointT = 6.471000e02
H2O.CriticalPointP = 2.210000e07
H2O.TriplePointT = 2.731500e02
H2O.TriplePointP = 6.110000e02
H2O.L_vaporization_BoilingPoint = 2.255000e06
H2O.L_vaporization_TriplePoint = 2.493000e06
H2O.L_fusion = 3.340000e05
H2O.L_sublimation = 2.840000e06
H2O.rho_liquid_BoilingPoint = 9.584000e02
H2O.rho_liquid_TriplePoint = 9.998700e02
H2O.rho_solid = 9.170000e02
H2O.cp = 1.847000e03
H2O.gamma = 1.331000e00
H2O.MolecularWeight = 1.800000e01
H2O.name = "Water"
H2O.formula = "H2O"
H2O.L_vaporization = 2.493000e06
H2O.rho_liquid = 9.998700e02
# ------------------------
CH4 = gas()
CH4.CriticalPointT = 1.904400e02
CH4.CriticalPointP = 4.596000e06
CH4.TriplePointT = 9.067000e01
CH4.TriplePointP = 1.170000e04
CH4.L_vaporization_BoilingPoint = 5.100000e05
CH4.L_vaporization_TriplePoint = 5.360000e05
CH4.L_fusion = 5.868000e04
CH4.L_sublimation = 5.950000e05
CH4.rho_liquid_BoilingPoint = 4.502000e02
CH4.rho_liquid_TriplePoint = None
CH4.rho_solid = 5.093000e02
CH4.cp = 2.195000e03
CH4.gamma = 1.305000e00
CH4.MolecularWeight = 1.600000e01
CH4.name = "Methane"
CH4.formula = "CH4"
CH4.L_vaporization = 5.360000e05
CH4.rho_liquid = 4.502000e02
# ------------------------
CO2 = gas()
CO2.CriticalPointT = 3.042000e02
CO2.CriticalPointP = 7.382500e06
CO2.TriplePointT = 2.165400e02
CO2.TriplePointP = 5.185000e05
CO2.L_vaporization_BoilingPoint = None
CO2.L_vaporization_TriplePoint = 3.970000e05
CO2.L_fusion = 1.960000e05
CO2.L_sublimation = 5.930000e05
CO2.rho_liquid_BoilingPoint = 1.032000e03
CO2.rho_liquid_TriplePoint = 1.110000e03
CO2.rho_solid = 1.562000e03
CO2.cp = 8.200000e02
CO2.gamma = 1.294000e00
CO2.MolecularWeight = 4.400000e01
CO2.name = "Carbon Dioxide"
CO2.formula = "CO2"
CO2.L_vaporization = 3.970000e05
CO2.rho_liquid = 1.110000e03
# ------------------------
N2 = gas()
N2.CriticalPointT = 1.262000e02
N2.CriticalPointP = 3.400000e06
N2.TriplePointT = 6.314000e01
N2.TriplePointP = 1.253000e04
N2.L_vaporization_BoilingPoint = 1.980000e05
N2.L_vaporization_TriplePoint = 2.180000e05
N2.L_fusion = 2.573000e04
N2.L_sublimation = 2.437000e05
N2.rho_liquid_BoilingPoint = 8.086000e02
N2.rho_liquid_TriplePoint = None
N2.rho_solid = 1.026000e03
N2.cp = 1.037000e03
N2.gamma = 1.403000e00
N2.MolecularWeight = 2.800000e01
N2.name = "Nitrogen"
N2.formula = "N2"
N2.L_vaporization = 2.180000e05
N2.rho_liquid = 8.086000e02
# ------------------------
O2 = gas()
O2.CriticalPointT = 1.545400e02
O2.CriticalPointP = 5.043000e06
O2.TriplePointT = 5.430000e01
O2.TriplePointP = 1.500000e02
O2.L_vaporization_BoilingPoint = 2.130000e05
O2.L_vaporization_TriplePoint = 2.420000e05
O2.L_fusion = 1.390000e04
O2.L_sublimation = 2.560000e05
O2.rho_liquid_BoilingPoint = 1.141000e03
O2.rho_liquid_TriplePoint = 1.307000e03
O2.rho_solid = 1.351000e03
O2.cp = 9.160000e02
O2.gamma = 1.393000e00
O2.MolecularWeight = 3.200000e01
O2.name = "Oxygen"
O2.formula = "O2"
O2.L_vaporization = 2.420000e05
O2.rho_liquid = 1.307000e03
# ------------------------
H2 = gas()
H2.CriticalPointT = 3.320000e01
H2.CriticalPointP = 1.298000e06
H2.TriplePointT = 1.395000e01
H2.TriplePointP = 7.200000e03
H2.L_vaporization_BoilingPoint = 4.540000e05
H2.L_vaporization_TriplePoint = None
H2.L_fusion = 5.820000e04
H2.L_sublimation = None
H2.rho_liquid_BoilingPoint = 7.097000e01
H2.rho_liquid_TriplePoint = None
H2.rho_solid = 8.800000e01
H2.cp = 1.423000e04
H2.gamma = 1.384000e00
H2.MolecularWeight = 2.000000e00
H2.name = "Hydrogen"
H2.formula = "H2"
H2.L_vaporization = 4.540000e05
H2.rho_liquid = 7.097000e01
# ------------------------
He = gas()
He.CriticalPointT = 5.100000e00
He.CriticalPointP = 2.280000e05
He.TriplePointT = 2.170000e00
He.TriplePointP = 5.070000e03
He.L_vaporization_BoilingPoint = 2.030000e04
He.L_vaporization_TriplePoint = None
He.L_fusion = None
He.L_sublimation = None
He.rho_liquid_BoilingPoint = 1.249600e02
He.rho_liquid_TriplePoint = None
He.rho_solid = 2.000000e02
He.cp = 5.196000e03
He.gamma = 1.664000e00
He.MolecularWeight = 4.000000e00
He.name = "Helium"
He.formula = "He"
He.L_vaporization = 2.030000e04
He.rho_liquid = 1.249600e02
# ------------------------
NH3 = gas()
NH3.CriticalPointT = 4.055000e02
NH3.CriticalPointP = 1.128000e07
NH3.TriplePointT = 1.954000e02
NH3.TriplePointP = 6.100000e03
NH3.L_vaporization_BoilingPoint = 1.371000e06
NH3.L_vaporization_TriplePoint = 1.658000e06
NH3.L_fusion = 3.314000e05
NH3.L_sublimation = 1.989000e06
NH3.rho_liquid_BoilingPoint = 6.820000e02
NH3.rho_liquid_TriplePoint = 7.342000e02
NH3.rho_solid = 8.226000e02
NH3.cp = 2.060000e03
NH3.gamma = 1.309000e00
NH3.MolecularWeight = 1.700000e01
NH3.name = "Ammonia"
NH3.formula = "NH3"
NH3.L_vaporization = 1.658000e06
NH3.rho_liquid = 7.342000e02
# ------------------------
...
def B(nu, T):
    u = min(h * nu / (k * T), 500.0)  # To prevent overflow
    return (2.0 * h * nu ** 3 / c ** 2) / (math.exp(u) - 1.0)
...
def satvpi(T):
    ...
    e = math.log10(esbasi)
    esice = 10.0 ** (aa + b + c + e)
    return 0.1 * esice  # Convert to Pascals
...
def satvpw(T):
    ...
    c = -1.3816e-07 * (10.0 ** (((1 - T / tbasw) * 11.344) - 1))
    d = 8.1328e-03 * (10.0 ** (((tbasw / T - 1) * (-3.49149)) - 1))
    e = math.log10(esbasw)
    esh2O = 10.0 ** (aa + b + c + d + e)
    return 0.1 * esh2O  # Convert to Pascals
...
def satvps(T, T0, e0, MolecularWeight, LatentHeat):
    ...
    return e0 * math.exp(-(LatentHeat / Rv) * (1.0 / T - 1.0 / T0))
...
class satvps_function:
    def __init__(
        self, Gas_or_T0, e0_or_iceFlag=None, MolecularWeight=None, LatentHeat=None
    ):
...
class MoistAdiabat:
    ...
    def __init__(self, condensible=H2O, noncon=air):
        ...
        def slope(logpa, logT):
            ...
            num = (1.0 + (self.L / (self.Ra * T)) * qsat) * self.Ra
            den = (
                self.cpa
                + (self.cpc + (self.L / (self.Rc * T) - 1.0) * (self.L / T)) * qsat
            )
            return num / den

        self.slope = slope
        self.ptop = 1000.0  # Default top of atmosphere
    ...
    def __call__(self, ps, Ts, pgrid=None):
        ...
        TL = [math.exp(logT)]
        # Integration loop
        p = 1.0e30  # Dummy initial value, to get started
        while p > ptop:
            ans = ad.next()
            pa = math.exp(ans[0])
            T = math.exp(ans[1])
        ...
        Mbar = molarConL * Mc + (1.0 - molarConL) * Mnc
